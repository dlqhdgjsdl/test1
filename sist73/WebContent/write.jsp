...
<script type="text/javascript">
   function send(){
	   ...
	   if(!obj.author.value||!obj.password.value||!obj.subject.value){
		   alert('id or check');
		   return false;
	   }
	   obj.submit();
...
<body>
  ...
  <c:set var="pageno" value="${param.page }"></c:set>
	...
	<form action="insert.do?cmd=insert" name="boardFrm" method="post">
	<div id="write-field">
		...
		<div class="col-md-6">
			...
			<!-- 	<tr>
						...
						<div class="row row-xs-bskr">
							<div class="col-md-6 col-sm-6 col-xs-bskr">
								...
								<div class="input-forms">
									<input size="20" type="text" name="author" value="${job!=null?info.author:''}"
										class="form-control input-sm input-name bskr-font user" />
									<input type="text" name="no" value="${job!=null?no:0}">
									<input type="text" name="job" value="${job!=null?job:'new'}">
									<input type="text" name="page" value="${job!=null?pageno:'1'}">										
								</div>
							</div>
							<div class="col-md-6 col-sm-6 col-xs-bskr">
								<div class="input-title">비밀번호</div>
								<div class="input-forms">
									<input size="20" type="password" name="password" value="${job!=null?info.password:''}"
				...
				<tr>
					...
					<input type="text"	name="subject" value="${job!=null?info.subject:''}"
				...
				<table>
					<tr>
						...
						<td calss="td2"><textarea class="form-control col-sm-5" name="contents"
								rows="20">${job!=null?info.contents:''}
								</textarea></td>
					</tr>
					<tr>
					<td class="td1"></td>
						<td class="td2"><input type="file" id="InputFile" name="fileName"></td>
					</tr>
				</table>
			</div>
			...
			<div class="bottombox">
				...
				<button id="submitPost" type="submit" class="btn btn-primary btn-sm">
					<i class="glyphicon glyphicon-ok" onclick="send()">확인</i> 
				</button>
			</div>
		</div>
	</div>
