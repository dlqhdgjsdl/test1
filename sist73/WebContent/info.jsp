		...
		<div class="list-group">
			<div class="list-group-item board-title">
				<div class="board-title">
					<span class="board-category">[MSG]</span><a href="#">
						${info.subject} </a> 
				</div>
			...
			<div class="list-group-item">
				...
				<a href="password.jsp?no=${info.no}&job=mod&page=1">
				...
				<a href="password.jsp?no=${info.no}&job=del&page=1">
					<button class="btn btn-warning">
						<i class="glyphicon glyphicon-thumbs-down">삭제</i>
					</button>
				</a>	
				</p>
			</div>
			<div class="bottom" style="margin: 10px;margin-top: 20px; text-align: right">
				<a href="list.do?cmd=list" class="btn btn-default btn-xs pull-left">목록으로</a> 
